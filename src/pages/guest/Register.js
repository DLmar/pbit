const Register = () => {
    return (
        <div>
            <div className="bg-neutral-100 dark:bg-midnight dark:text-white relative transitionClass">
                ...
                <div className="container min-h-screen flex justify-center py-[229px]">
                    <div className="relative w-[636px]">
                        <div
                            ...
                            <h2 className="text-2xl md:text-4xl text-center text-accent_dark dark:text-white">Register <br/> of
                                your <span
                            ...
                            <div className="flex justify-between pt-5">
                                ...
                                <a href='/account'>
                                    <button
                                        className="text-sm font-medium w-[137px] h-[47px] text-accent_dark bg-accent_yellow dark:bg-light_yellow rounded-[5px]">Registration
                                    </button>
                                </a>
                            </div>
                            <p className="text-sm text-center pt-[25px] md:pt-[30px]">Don't have an account?
                                <a href="{{'guest/login'|page}}"
                                   className="text-accent_yellow dark:text-light_yellow">Sign in</a>
                            </p>
                            <p className="text-sm text-center pt-[10px] md:pt-[15px]">By signing up I agree
                                with
                                <a href="{{'guest/terms'|page}}"
                                   className="text-accent_yellow dark:text-light_yellow">Terms of
                                    service</a> and processing of personal data as started in the
                                <a href="#" className="text-accent_yellow dark:text-light_yellow">Privacy policy</a>
                            </p>
                        </div>
